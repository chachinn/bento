const CACHE='bento-shell-v0.7.0-v21';
const SHELL_PREFIX='bento-shell-';
const ASSET_VERSION='21';
const CORE=[
  './index.html',
  './style.css?v=21',
  './data/recipes-data.js?v=21',
  './data/photo-index.js?v=21',
  './data/library_manifest.json',
  './manifest.json',
  './data/korean-runtime.js?v=21',
  './data/korean-recipes-00.js?v=21',
  './data/korean-recipes-01.js?v=21',
  './data/korean-recipes-02.js?v=21',
  './data/korean-recipes-03.js?v=21',
  './data/korean-recipes-04.js?v=21',
  './data/korean-recipes-05.js?v=21',
  './data/korean-recipes-06.js?v=21',
  './data/korean-recipes-07.js?v=21',
  './data/korean-recipes-08.js?v=21',
  './data/korean-recipes-09.js?v=21',
  './data/anime-runtime.js?v=21',
  './data/anime-recipes-00.js?v=21',
  './data/anime-recipes-01.js?v=21',
  './data/anime-recipes-02.js?v=21',
  './data/anime-recipes-03.js?v=21',
  './data/anime-recipes-04.js?v=21',
  './data/anime-recipes-05.js?v=21',
  './data/anime-recipes-06.js?v=21',
  './data/anime-recipes-07.js?v=21',
  './data/anime-recipes-08.js?v=21',
  './data/anime-recipes-09.js?v=21',
  './app.js?v=21'
];
