...
function inferAllergens(ingredients){
  ...
  if(has(dairy,/\b(whole milk|fresh milk|evaporated milk|condensed milk|buttermilk|cream|heavy cream|whipping cream|butter|ghee|cheese|parmesan|mozzarella|cheddar|paneer|chhena|chenna|chhurpi|khoya|khoa|mawa|rabri|curd|dahi|yogurt|yoghurt|milk powder|powdered milk|ice cream)\b/)||/(^|[^a-z])milk([^a-z]|$)/.test(dairy))out.push('milk');
  if(has(raw,/\b(fish sauce|bonito|katsuobushi|dashi|anchov(?:y|ies)|salmon|tuna|mackerel|cod|sardines?|fish cake|chikuwa|kamaboko|tilapia|bangus|milkfish|sea bass|perch|trout|snapper|shirasu|hilsa|ilish|rohu|carp|fermented fish|fermented dried fish)\b/))out.push('fish');
