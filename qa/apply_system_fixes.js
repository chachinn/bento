...
if(!index.includes('data/recipe-quality-runtime.js'))index=index.replace(/(<script src="app\.js\?v=24p2" defer><\/script>)/,'<script src="data/recipe-quality-runtime.js?v=24p2" defer></script>\n  $1');
...
if(!sw.includes("'./data/recipe-quality-runtime.js?v=24p2'"))sw=sw.replace("  './app.js?v=24p2'","  './data/recipe-quality-runtime.js?v=24p2',\n  './app.js?v=24p2'");
